...
where f.codigo = p.codigo_fabricante and f.codigo = 7;

select f.nombre, f.codigo from fabricante f, producto p where f.codigo = p.codigo_fabricante and f.codigo = 7;
